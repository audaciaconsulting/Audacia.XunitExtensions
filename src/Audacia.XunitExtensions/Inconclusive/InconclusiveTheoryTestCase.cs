...
{
    /// <summary>
    /// Subclass of <see cref="XunitTestCase"/> that runs tests decorated with <see cref="InconclusiveTheoryAttribute"/>.
    /// </summary>
    [Serializable]
    public class InconclusiveTheoryTestCase : XunitTheoryTestCase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InconclusiveTheoryTestCase"/> class.
        /// </summary>
        [EditorBrowsable(EditorBrowsableState.Never)]
        [Obsolete("Called by the de-serializer", true)]
        public InconclusiveTheoryTestCase() { }
